      ...
      <div className="flex items-center gap-4">
        <div className="relative">
          ...
          {alertasPendientes != null && alertasPendientes > 0 && (
            <span className="absolute -top-1 -right-1 w-3.5 h-3.5 bg-[#F7415C] rounded-full text-[8px] text-white flex items-center justify-center font-bold font-mono">
              {alertasPendientes > 9 ? '9+' : alertasPendientes}
            </span>
          )}
        </div>
        <div className="w-7 h-7 bg-[#F7415C] flex items-center justify-center">
